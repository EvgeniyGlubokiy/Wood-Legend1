<?php
	...
	*/
	...
	$mail->setFrom('Woodlegend.info@gmail.com', 'Заявка з сайту'); // Вказати потрібний E-mail
	//Кому відправити
	$mail->addAddress('Woodlegend.info@gmail.com'); // Вказати потрібний E-mail
	//Тема листа
   ...
   $body .= 'Телефон: ' . $_POST['phone'] . ' <br />';
	$body .= 'Пошта: ' . $_POST['email'] . ' <br />';
	$body .= 'Повідомлення: ' . $_POST['text'] . ' <br />';
